    ...
    <div class="container-fluid">
        <div class="">
            <div class="banner_carousel">
                ...
                <div class="banner_single">
                    <figure>
                        <img src="img/home/banner_first4.jpg" class="img-fluid" alt="">
                    </figure>
                    <div class="banner_content">
                        <p>Helping Them Today</p>
                        <h1>Helping in christ's Name in Christ's way</h1>
                ...
                <div class="banner_single">
                    <figure>
                        <img src="img/home/banner_first5.jpg" class="img-fluid" alt="">
                    </figure>
                    <div class="banner_content">
                        <p>Helping Them Today</p>
                        <h1>Helping in christ's Name in Christ's way</h1>
                ...
                <div class="banner_single">
                    <figure>
                        <img src="img/home/banner_first6.jpg" class="img-fluid" alt="">
                    </figure>
                    <div class="banner_content">
                        <p>Helping Them Today</p>
                        <h1>Helping in christ's Name in Christ's way</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="">
                    <figure>
                        <img src="img/home/dg-min.jpg" class="img-fluid" alt="">
                    </figure>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="healthy_leftside">
                    ...
                    <figure>
                        <img src="img/home/footer-map.png" class="img-fluid" alt="">
                    </figure>
                </div>
            </div>
            <div class="col-md-6">
                <div class="healthy_rightside">
                    <div class="healthy_iconimg">
                        <figure>
                            <img src="img/home/icon1.png" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div>
                ...
                <div class="healthy_rightside">
                    <div class="healthy_iconimg">
                        <figure>
                            <img src="img/home/icon2.png" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div>
                ...
                <div class="healthy_rightside">
                    <div class="healthy_iconimg">
                        <figure>
                            <img src="img/home/icon3.png" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div>
            ...
            <div class="col-md-6">
                <div class="ask_ques_right">
                    ...
                    <div class="bot_orange_dv">
                        <figure>
                            <img src="img/home/icon4.png" class="img-fluid" alt="">
                        </figure>
                        <p>
...
<section class="seven_sec join_pray-sec">
    <div class="container">
        <div class="join_pray_content">
            <figure>
                <img src="img/home/icon5.png" class="img-fluid" alt="">
            </figure>
            <hr class="black_liner">
            <div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 align-self-center">
                <div class="button-group">
                    <a href="#" class="btn gcmco-btn">See All News</a>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
...
<section class="help_people_sec ninth_sec">
    <div class="container-fluid">
        ...
        <div class="help_people_carousel">
            <div>
                <figure>
                    <img src="img/home/help_people1.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people2.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people3.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people4.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people5.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people6.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people7.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people8.jpg" class="img-fluid" alt="">
                </figure>
            </div>
            <div>
                <figure>
                    <img src="img/home/help_people9.jpg" class="img-fluid" alt="">
                </figure>
            </div>
        </div>
    </div>
